...
const PRODUCTS = [
  ...
  },
  {
    name: "mcp-guard",
    emoji: "🔐",
    tagline: "MCP Security Gateway",
    desc: "Auth, rate limits, spend caps, and audit logs in front of any MCP server. Drop-in replacement — zero code changes. GitHub Action for scanning MCP configs on PRs.",
    repo: "mcp-guard",
    status: "v0.1.1",
    category: "flagship",
    color: "from-red-500 to-orange-500",
    features: ["API-key / JWT auth", "Per-agent rate limiting", "Spend caps (wallet/x402)", "JSONL audit logs", "GitHub Action for PRs", "Zero dependencies"],
    install: "pip install bonanza-mcp-guard",
