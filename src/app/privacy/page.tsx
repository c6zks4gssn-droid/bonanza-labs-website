...
const sections = [
  {
    ...
    paragraphs: [
      "BonanzaLabs is verantwoordelijk voor de verwerking van persoonsgegevens via bonanza-labs.com, het contactformulier, de chat en betaalprocessen.",
      "Voor privacyvragen of verzoeken kun je contact opnemen via hello@bonanzalabs.com.",
    ],
  },
  {
    title: "2. Welke persoonsgegevens verwerken we?",
    paragraphs: [
      "Afhankelijk van hoe je de website gebruikt, verwerken we je naam, e-mailadres, bedrijfsinformatie, berichtinhoud, bronpagina, IP-adres, browserinformatie en technische loggegevens.",
  ...
  },
  {
    ...
    paragraphs: [
      "We gebruiken persoonsgegevens om vragen te beantwoorden, afspraken en Flow Assessments te plannen, betalingen af te handelen, diensten te leveren, misbruik te voorkomen en onze website en processen te verbeteren.",
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "Stuur je verzoek naar hello@bonanzalabs.com. We kunnen aanvullende informatie vragen om je identiteit te controleren, maar vragen niet meer gegevens dan daarvoor nodig zijn. Je kunt ook een klacht indienen bij de Autoriteit Persoonsgegevens.",
    ],
  },
  {
    title: "8. Cookies en technische opslag",
    paragraphs: [
      "De website kan functionele opslag gebruiken die nodig is voor navigatie, beveiliging en het correct uitvoeren van formulieren en betalingen. Niet-noodzakelijke analytics- of marketingcookies worden pas toegevoegd wanneer daarvoor een passende grondslag en, indien vereist, toestemming is geregeld.",
    ],
  },
  {
    title: "9. Wijzigingen",
    paragraphs: [
      "We kunnen deze verklaring aanpassen wanneer onze diensten of leveranciers veranderen. De meest recente versie staat altijd op deze pagina.",
    ],
  },
];
  ...
  return (
    <main className="min-h-screen bg-[#070A12] text-white">
      ...
      <div className="mx-auto max-w-4xl px-6 py-16">
        <div className="rounded-2xl border border-cyan-300/20 bg-cyan-300/5 p-6 text-sm leading-7 text-slate-300">
          Deze verklaring is afgestemd op de huidige websitefuncties. Vul vóór productie ook de officiële handelsnaam, het KvK-nummer, vestigingsadres en eventuele functionaris of contactpersoon aan wanneer die gegevens beschikbaar zijn.
        </div>
        ...
        <div className="mt-16 rounded-3xl border border-white/10 bg-[#0D1220] p-8">
          ...
          <a href="mailto:hello@bonanzalabs.com" className="mt-6 inline-flex rounded-xl bg-[#2563EB] px-5 py-3 font-semibold hover:bg-[#1D4ED8]">hello@bonanzalabs.com</a>
        </div>
      </div>

      <footer className="border-t border-white/10 px-6 py-10">
        <div className="mx-auto flex max-w-5xl flex-col justify-between gap-4 text-sm text-slate-500 md:flex-row"><p>© 2026 BonanzaLabs</p><div className="flex gap-5"><Link href="/blog" className="hover:text-white">Kennisbank</Link><Link href="/pricing" className="hover:text-white">Prijzen</Link><Link href="/contact" className="hover:text-white">Contact</Link></div></div>
      </footer>
    </main>
  );
}
